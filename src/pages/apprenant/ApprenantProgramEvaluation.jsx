...
export default function ApprenantProgramEvaluation() {
  ...
  const {
    ...
    isLastBlock,
    progress
  } = useProgramEvaluation(user?.uid, programId, targetOrgId);
  ...
  const handleFinish = async () => {
    if (!window.confirm('Terminer l\'évaluation complète et voir les résultats ?')) return;
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <div style={{ fontSize: '12px', color: '#64748b', fontWeight: '600' }}>
            Chargement de l'évaluation complète...
          </div>
        </div>
      </div>
    );
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ fontSize: '11px', color: '#64748b', marginBottom: '17px' }}>
            Ce programme ne contient pas encore d'exercices pour l'évaluation.
          </p>
          <button
